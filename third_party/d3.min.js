...
!(function (t, n) {
  ...
  function ht(t, n) {
    ...
    return (
      ...
      (l.tickArguments = function (t) {
        return arguments.length
          ? ((e = null == t ? [] : it.call(t)), l)
          : e.slice()
      }),
      (l.tickValues = function (t) {
        return arguments.length
          ? ((r = null == t ? null : it.call(t)), l)
          : r && r.slice()
      }),
  ...
  function Dm(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i)
    return (
      (zm(o) + zm(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    )
  }
  function qm(t, n) {
  ...
  Qm.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Qm(this.k, this.x + this.k * t, this.y + this.k * n)
    },
    apply: function (t) {
    ...
    (t.zoom = function () {
      ...
      return (
        ...
        (y.wheelDelta = function (t) {
          return arguments.length
            ? ((a = 'function' == typeof t ? t : Zm(+t)), y)
            : a
        }),
        (y.filter = function (t) {
          return arguments.length
            ? ((r = 'function' == typeof t ? t : Zm(!!t)), y)
            : r
        }),
        (y.touchable = function (t) {
          return arguments.length
            ? ((u = 'function' == typeof t ? t : Zm(!!t)), y)
            : u
        }),
        (y.extent = function (t) {
          return arguments.length
